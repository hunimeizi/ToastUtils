...
public class SystemToast implements IToast, Cloneable {
    ...
    public void showShort() {
        this.setDuration(DToast.DURATION_SHORT).show();
    }
    ...
    private static void hookHandler(Toast toast) {
        ...
        try {
            @SuppressLint("SoonBlockedPrivateApi") Field sField_TN = Toast.class.getDeclaredField("mTN");
    ...
    private static void hookINotificationManager(Toast toast, Context mContext) {
        ...
        if (isValid4HookINotificationManager()) {
            ...
            try {
                ...
                @SuppressLint("SoonBlockedPrivateApi") Field sServiceFiled = Toast.class.getDeclaredField("sService");
